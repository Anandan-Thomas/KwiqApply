...
$result = mysqli_query($con,"SELECT * FROM u_reg_data WHERE u_id='.$userr_id.'");
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <br>
                   ...
                   <?php
                    ...
                    $result1 = mysqli_query($con,"SELECT * FROM u_reg_data where u_id='".$userr_id."'");
                ...
                <tr>
                    ...
                    <td colspan="3"> <?php echo $userr_id ?> </td>
                </tr>
